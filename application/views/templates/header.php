...
<head>
    ...
    <!-- Custom Styling for Blue Sidebar -->
    <style>
        .sidebar-left {
        ...
        .sidebar-left .navbar-brand svg polygon {
            fill: white;
        }
    </style>
</head>
...
<div class="wrapper d-flex flex-column flex-grow-1 h-100">
    ...
    <aside class="sidebar-left border-right bg-primary text-white shadow" id="leftSidebar" data-simplebar>
        <a href="#" class="btn collapseSidebar toggle-btn d-lg-none text-white ml-2 mt-3" data-toggle="toggle">
            <i class="fe fe-x"><span class="sr-only"></span></i>
        </a>
        <nav class="vertnav navbar navbar-light">
           <div class="w-100 mb-4 d-flex">
                <a class="navbar-brand mx-auto mt-3 flex-fill text-center text-white font-weight-bold" href="<?php echo base_url('dashboard'); ?>" style="font-size: 24px;">
                    SIMRS
                </a>
            </div>
            ...
            <ul class="navbar-nav flex-fill w-100 mb-2">
                ...
                <?php if ($this->session->userdata('role') == 'admin' || $this->session->userdata('role') == 'receptionis'): ?>
                    <li class="nav-item">
                        <a href="<?php echo base_url('pasien'); ?>" class="nav-link text-white">
                ...
                <?php if ($this->session->userdata('role') == 'admin' || $this->session->userdata('role') == 'dokter'): ?>
                    <li class="nav-item">
                        <a href="<?php echo base_url('dokter'); ?>" class="nav-link text-white">
                ...
                <?php if ($this->session->userdata('role') == 'admin'): ?>
                    <li class="nav-item">
                        <a href="<?php echo base_url('poli'); ?>" class="nav-link text-white">
                ...
                <?php endif; ?>
                <li class="nav-item">
                    <a href="<?php echo base_url('kunjungan'); ?>" class="nav-link text-white">
